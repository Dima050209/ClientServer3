...
public class Decryptor extends Thread{
    ...
    public Decryptor(byte[] packet, Socket clientSocket) {
        this.packet = packet;
        this.clientSocket = clientSocket;
        this.start();
    }
    public Decryptor(byte[] packet, DatagramSocket datagramSocket, InetAddress address, int port) {
        this.packet = packet;
        ...
        try {
            ...
            if(clientSocket != null) {
                Processor processor = new Processor(
                        objectMapper.readValue(messageBuffer, Command.class), clientSocket);
                processor.join();
            } else {
                Processor processor = new Processor(
                        objectMapper.readValue(messageBuffer, Command.class), datagramSocket, address, port);
                processor.join();
            }
